...
const slug = "beheshti-minbar-social-authority-political-leadership";
    ...
    <main className="article-page">
      ...
      <article>
        ...
        <div className="article-provenance">
          ...
          <div><b>شناسه</b><span>AZ-R04</span></div>
        ...
        <aside className="citation-box">
          ...
          <p>بنیاد آذرخش، «{post.title}»، شناسهٔ AZ-R04، تاریخ دسترسی: {new Date().toLocaleDateString("fa-AF")}.</p>
        </aside>
      </article>
    </main>
  );
