...
export type PublicationListItem = { id: number; slug: string; title: string; excerpt: string; category: string; contentType: string; language: string; visibility: string; authorName: string; coverImage: string | null; tags: string; publishedAt: string | null; articleNo?: number | null };
