...
export const defaultSiteSettings: SiteSettings = {
  ...
  hero: { eyebrow: "بنیاد مستقل تاریخ‌پژوهی افغانستان", title: "تاریخ، آنگاه روشن می‌شود که اسناد سخن بگویند.", highlightedWord: "اسناد", description: "بنیاد آذرخش برای گردآوری، سنجش و بازتاب حقیقت‌های تاریخی افغانستان شکل گرفته است؛ با تمرکز ویژه بر حکومت شورای اتفاق اسلامی افغانستان و میراث فکری و سیاسی حضرت آیت‌الله العظمی بهشتی(ره).", primaryButton: "مطالعهٔ پروندهٔ محوری", secondaryButton: "روایت یا سندی دارید؟", principle: "هر ادعا باید از مسیر منبع، نقد و راستی‌آزمایی عبور کند." },
