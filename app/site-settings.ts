...
export type LinkCard = { id: string; title: string; text: string; href: string; label?: string };
export type ArchiveItem = { id: string; category: string; title: string; text: string; code: string; status: string };

export type SiteSettings = {
  identity: { siteName: string; tagline: string; logoUrl: string };
  media: { leaderImageUrl: string; councilEmblemUrl: string; leaderImageAlt: string; councilEmblemAlt: string; councilEmblemCaption: string };
  navigation: { about: string; council: string; leader: string; archive: string; publications: string; contribute: string; cta: string };
  hero: { eyebrow: string; title: string; highlightedWord: string; description: string; primaryButton: string; secondaryButton: string; principle: string };
...
export const defaultSiteSettings: SiteSettings = {
  identity: { siteName: "بنیاد آذرخش", tagline: "آذرخش؛ قاتل تاریکی و سایه‌یی سایه!", logoUrl: "/azarakhsh-logo-transparent-web.png" },
  media: { leaderImageUrl: "/api/media/site%2Fayatollah-beheshti.webp", councilEmblemUrl: "/api/media/site%2Fshura-e-ettefaq-emblem.webp", leaderImageAlt: "حضرت آیت‌الله العظمی بهشتی(ره)", councilEmblemAlt: "نشان تاریخی حکومت شورای اتفاق اسلامی افغانستان", councilEmblemCaption: "نسخهٔ آرشیوی؛ تاریخ و منشأ دقیق در حال تکمیل است." },
  navigation: { about: "دربارهٔ بنیاد", council: "شورای اتفاق", leader: "آیت‌الله بهشتی", archive: "آرشیو", publications: "نشرها", contribute: "همکاری پژوهشی", cta: "تازه‌ترین نشرها" },
  hero: { eyebrow: "بنیاد مستقل تاریخ‌پژوهی افغانستان", title: "تاریخ، آنگاه روشن می‌شود که اسناد سخن بگوید.", highlightedWord: "اسناد", description: "بنیاد آذرخش برای گردآوری، حفاظت، نقد و انتشار مسئولانهٔ منابع تاریخی ایجاد شده است؛ با تمرکز ویژه بر حکومت شورای اتفاق اسلامی افغانستان، میراث آیت‌الله بهشتی«ره» و همراهان و مجاهدان غیور آن‌زمان.", primaryButton: "مطالعهٔ پروندهٔ محوری", secondaryButton: "روایت یا سندی دارید؟", principle: "هر ادعا باید از مسیر منبع، نقد و راستی‌آزمایی عبور کند." },
  mission: { kicker: "مسیر پژوهش", title: "از حافظهٔ پراکنده تا روایتِ قابل دفاع", text: "آذرخش میان خاطره و سند، روایت و نقد، و گذشته و پرسش‌های امروز پیوند می‌سازد؛ نه برای اسطوره‌سازی، بلکه برای نزدیک‌شدن منصفانه به حقیقت.", cards: missionCards },
  council: { kicker: "حکومت شورای اتفاق اسلامی افغانستان", title: "حکومتی که باید دوباره، دقیق و بی‌هراس خوانده شود.", text: "شورای اتفاق را نمی‌توان به یک نام در حاشیهٔ رخدادها فروکاست. این تجربه، پرسشی بنیادی دربارهٔ نظم سیاسی، اقتدار محلی، وحدت اجتماعی و دولت‌سازی در هزاره‌جات پیش روی پژوهشگر می‌گذارد.", mapTitle: "شورای اتفاق", mapStatus: "پروندهٔ باز", axes: [
  ...
  leader: { kicker: "زندگی، اندیشه و رهبری", title: "حضرت آیت‌الله العظمی بهشتی(ره)", lead: "پرونده‌ای برای شناخت یک رهبر در متن تاریخ؛ از سیر علمی و اجتماعی تا تصمیم‌های سیاسی و میراث ماندگار.", quote: "تاریخ شخصیت‌ها را نه با ستایش، بلکه با سند، زمینه و پیامد می‌سنجد.", quoteSource: "روش پژوهشی بنیاد آذرخش", inquiries: [
  ...
  timeline: { kicker: "خط زمانی", title: "رویدادها در بستر زمان", text: "تاریخ‌نگاری دقیق به ترتیب زمانی، زمینهٔ سیاسی و نسبت رویدادها نیاز دارد.", items: [] },
  archive: { kicker: "پرونده‌های پژوهشی", title: "آرشیو زندهٔ تاریخ", searchPlaceholder: "جست‌وجو در آرشیو...", items: archiveItems },
  standards: { kicker: "معیارهای بنیاد", title: "پژوهش مسئولانه و قابل ارزیابی", text: "هر متن، تصویر، روایت و سند پیش از انتشار باید از مسیر سنجش منبع، زمینه و شفافیت عبور کند.", items: [
  ...
  method: { kicker: "روش کار", title: "از دریافت منبع تا نشر نهایی", items: [
  ...
  contribute: { kicker: "همکاری پژوهشی", title: "سند، تصویر یا روایتی در اختیار دارید؟", text: "با ارسال منبع، در تکمیل حافظهٔ تاریخی و ساختن یک آرشیو معتبر سهم بگیرید.", button: "مشاهدهٔ راهنمای ارسال", types: [
...
export function mergeSiteSettings(settings?: DeepPartial<SiteSettings> | null): SiteSettings { return deepMerge(defaultSiteSettings, settings ?? undefined) }
