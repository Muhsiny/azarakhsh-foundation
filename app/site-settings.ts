...
export const defaultSiteSettings: SiteSettings = {
  identity: { siteName: "بنیاد آذرخش", tagline: "آذرخش؛ درخششی برای روشن‌کردن حافظهٔ تاریخ.", logoUrl: "/azarakhsh-logo-transparent-web.png" },
  media: { leaderImageUrl: "/media/beheshti-original.webp", councilEmblemUrl: "/media/council-emblem.webp", leaderImageAlt: "حضرت آیت‌الله العظمی بهشتی(ره)", councilEmblemAlt: "نشان تاریخی حکومت شورای اتفاق اسلامی افغانستان", councilEmblemCaption: "نسخهٔ آرشیوی؛ تاریخ و منشأ دقیق در حال تکمیل است." },
  ...
  hero: { eyebrow: "بنیاد مستقل تاریخ‌پژوهی افغانستان", title: "تاریخ، آنگاه روشن می‌شود که اسناد سخن بگویند.", highlightedWord: "اسناد", description: "بنیاد آذرخش برای گردآوری، حفاظت، نقد و انتشار مسئولانهٔ منابع تاریخی ایجاد شده است؛ با تمرکز ویژه بر حکومت شورای اتفاق اسلامی افغانستان، میراث آیت‌الله بهشتی«ره» و همراهان و مجاهدان غیور آن‌زمان.", primaryButton: "مطالعهٔ پروندهٔ محوری", secondaryButton: "روایت یا سندی دارید؟", principle: "هر ادعا باید از مسیر منبع، نقد و راستی‌آزمایی عبور کند." },
