...
export const siteSettings: Readonly<SiteSettings> = {
  ...
  navigation: {
    primary: [
      { href: "/", label: "آغاز", enabled: true },
      { href: "/about", label: "دربارهٔ بنیاد", enabled: true },
      { href: "/council", label: "حکومت شورای اتفاق", enabled: true },
      { href: "/beheshti", label: "آیت‌الله بهشتی", enabled: true },
      { href: "/archive", label: "آرشیف", enabled: true },
      { href: "/publications", label: "نشریات", enabled: true },
      { href: "/contribute", label: "ارسال سند", enabled: true },
    ],
    more: [
      { href: "/standards", label: "روش پژوهش", enabled: true },
      { href: "/governance", label: "ساختار و پاسخ‌گویی", enabled: true },
      { href: "/join", label: "عضویت پژوهشی", enabled: true },
      { href: "/login", label: "ورود اعضا", enabled: true },
      { href: "/account", label: "حساب من", enabled: true },
      { href: "/contact", label: "تماس", enabled: true },
    ],
    footer: [
      { href: "/about", label: "دربارهٔ بنیاد", enabled: true },
      { href: "/standards", label: "روش پژوهش", enabled: true },
      { href: "/archive", label: "آرشیف", enabled: true },
      { href: "/publications", label: "نشریات", enabled: true },
      { href: "/contribute", label: "ارسال سند و خاطره", enabled: true },
      { href: "/join", label: "عضویت پژوهشی", enabled: true },
      { href: "/login", label: "ورود اعضا", enabled: true },
      { href: "/account", label: "حساب من", enabled: true },
      { href: "/privacy", label: "حریم خصوصی و حقوق نشر", enabled: true },
      { href: "/contact", label: "تماس با ما", enabled: true },
    ],
  },
  contact: {
